	...
	; Compiler options:
	;
	; -oTGB_Motor_Ver2.cof -mTGB_Motor_Ver2.map --summary=default \
	; --output=default Main.p1 I2C.p1 ADC.p1 --chip=16F1784 -P \
	; --runtime=default --opt=default -N-1 --debugger=icd3 -g --asmlist \
...
;Stack space: 02057h-021EFh (409 bytes)
...
;	BORV = HI, Brown-out Reset Voltage (Vbor), high trip point selected.
...
;	WRT = ALL, 000h to 7FFh write protected, no addresses may be modified by EECON control
;	PLL Enable
;	PLLEN = OFF, 4x PLL disabled
